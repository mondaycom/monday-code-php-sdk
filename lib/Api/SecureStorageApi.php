...
class SecureStorageApi
{
     ...
     * @return void
     */
    public function putSecureStorage($key, $storage_data_contract, string $contentType = self::contentTypes['putSecureStorage'][0])
    {
        $this->putSecureStorageWithHttpInfo($key, $storage_data_contract, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function putSecureStorageWithHttpInfo($key, $storage_data_contract, string $contentType = self::contentTypes['putSecureStorage'][0])
    {
        $request = $this->putSecureStorageRequest($key, $storage_data_contract, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSecureStorageAsync($key, $storage_data_contract, string $contentType = self::contentTypes['putSecureStorage'][0])
    {
        return $this->putSecureStorageAsyncWithHttpInfo($key, $storage_data_contract, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSecureStorageAsyncWithHttpInfo($key, $storage_data_contract, string $contentType = self::contentTypes['putSecureStorage'][0])
    {
        $returnType = '';
        $request = $this->putSecureStorageRequest($key, $storage_data_contract, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putSecureStorageRequest($key, $storage_data_contract, string $contentType = self::contentTypes['putSecureStorage'][0])
    {
        ...
        if ($storage_data_contract === null || (is_array($storage_data_contract) && count($storage_data_contract) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $storage_data_contract when calling putSecureStorage'
            );
        }
